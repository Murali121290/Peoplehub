...
class Employee(db.Model):
    ...
    # Leave Balance
    sick_leave = db.Column(db.Float, default=0.0)
    casual_leave = db.Column(db.Float, default=0.0)
    privilege_leave = db.Column(db.Float, default=0.0)
