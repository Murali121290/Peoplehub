...
export const DatePicker: React.FC<DatePickerProps> = ({
  ...
  return (
    <div className="relative w-full">
      ...
      {/* Picker Dialog Modal overlay */}
      {isOpen && (
        <div className="fixed inset-0 bg-neutral-900/40 backdrop-blur-[2px] flex items-center justify-center z-50 p-4 animate-fadeIn">
          {/* Modal box */}
          <div className="bg-white rounded-3xl shadow-2xl w-[290px] overflow-hidden border border-neutral-100 flex flex-col animate-scaleIn">
            
            {/* Header: SELECT DATE */}
            <div className="bg-[#6200EE] p-5 flex items-center justify-between text-white">
              <div>
                <p className="text-[10px] font-bold tracking-wider uppercase opacity-80">Select Date</p>
                <h3 className="text-2xl font-bold mt-1 tracking-tight">{getHeaderString()}</h3>
              </div>
              <button
                type="button"
            ...
            {inputMode === "calendar" ? (
              ...
              <div className="p-6 flex flex-col justify-center items-center h-[260px]">
                <div className="w-full">
                  ...
                  <input
                    ...
                    className="w-full border border-slate-300 rounded-xl px-4 py-2.5 text-sm text-slate-700 focus:border-[#6200EE] focus:outline-none font-medium shadow-sm"
                  />
                </div>
