    ...
    <div className="space-y-6 relative">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-6 rounded-2xl border border-neutral-200/80 shadow-sm">
        <div className="flex items-center gap-3.5">
          <div className="p-3 bg-success-50 text-success-600 rounded-2xl border border-success-100 shadow-inner">
            <CalendarDaysIcon className="w-6 h-6" />
          </div>
          <div>
            <h2 className="text-xl font-bold text-neutral-800">Leave Approval Requests</h2>
            <p className="text-xs text-neutral-500 font-medium mt-1">Manage and review leave requests from your team members.</p>
          </div>
        </div>
