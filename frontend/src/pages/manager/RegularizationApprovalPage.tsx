          ...
          <div className="bg-white rounded-3xl p-6 w-full max-w-md shadow-2xl border border-neutral-200 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setAddedMinutesInput(Math.min(5, Math.max(0, val)));
                  }}
              ...
              <p className="text-[11px] text-neutral-500">
                ⚡ Specify additional minutes (max 5m) to credit towards total worked time on this date. If total hours reach 7h 55m (grace period), status will automatically update to <strong className="text-success-700">Present</strong>.
              </p>
            </div>
