...
const EmployeeClarificationModal: React.FC<EmployeeClarificationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-neutral-900/80 backdrop-blur-md flex items-center justify-center z-[99999] p-4 overscroll-contain">
      <div className="bg-white rounded-[24px] shadow-2xl w-[520px] max-w-[95vw] overflow-hidden border border-amber-200 flex flex-col animate-in fade-in zoom-in-95 duration-200">
        
        {/* Header - Non Dismissable Warning */}
        <div className="bg-gradient-to-r from-amber-600 via-amber-700 to-orange-600 text-white px-6 py-4 flex items-center gap-3">
        ...
        <div className="p-6 space-y-4 overflow-y-auto max-h-[75vh]">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2.5 max-h-44 overflow-y-auto pr-1">
              {history.length > 0 ? (
                ...
                <div className="bg-amber-50/90 border border-amber-200 p-3.5 rounded-xl text-amber-950 text-xs font-medium">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 pt-2 border-t border-neutral-100">
            ...
            <textarea
              ...
              className="w-full p-3 text-xs border border-neutral-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-neutral-50/50"
            />
